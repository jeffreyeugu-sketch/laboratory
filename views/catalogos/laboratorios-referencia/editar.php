<?php
/**
 * Vista: Editar Laboratorio de Referencia
 */
?>
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="mb-1">Editar Laboratorio de Referencia</h2>
            <p class="text-muted mb-0">
                Modificar datos de: <strong><?= htmlspecialchars($laboratorio['nombre']) ?></strong>
            </p>
        </div>
    ...
    <div class="row">
        <div class="col-lg-9">
            <form action="<?= url('/catalogos/laboratorios-referencia/actualizar/' . $laboratorio['id']) ?>" 
                  method="POST" 
                  id="formLaboratorio">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="codigo" 
                                       name="codigo" 
                                       value="<?= htmlspecialchars($old['codigo'] ?? $laboratorio['codigo']) ?>"
                                       maxlength="20"
                            ...
                            <div class="col-md-9 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="nombre" 
                                       name="nombre" 
                                       value="<?= htmlspecialchars($old['nombre'] ?? $laboratorio['nombre']) ?>"
                                       maxlength="150"
                                       required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="razon_social" 
                                       name="razon_social" 
                                       value="<?= htmlspecialchars($old['razon_social'] ?? $laboratorio['razon_social'] ?? '') ?>"
                                       maxlength="200">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="rfc" 
                                       name="rfc" 
                                       value="<?= htmlspecialchars($old['rfc'] ?? $laboratorio['rfc'] ?? '') ?>"
                                       maxlength="15"
                                       style="text-transform: uppercase;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="direccion" 
                                       name="direccion" 
                                       value="<?= htmlspecialchars($old['direccion'] ?? $laboratorio['direccion'] ?? '') ?>"
                                       maxlength="255">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="ciudad" 
                                       name="ciudad" 
                                       value="<?= htmlspecialchars($old['ciudad'] ?? $laboratorio['ciudad'] ?? '') ?>"
                                       maxlength="100">
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="estado" 
                                       name="estado" 
                                       value="<?= htmlspecialchars($old['estado'] ?? $laboratorio['estado'] ?? '') ?>"
                                       maxlength="100">
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="codigo_postal" 
                                       name="codigo_postal" 
                                       value="<?= htmlspecialchars($old['codigo_postal'] ?? $laboratorio['codigo_postal'] ?? '') ?>"
                                       maxlength="10">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="telefono" 
                                       name="telefono" 
                                       value="<?= htmlspecialchars($old['telefono'] ?? $laboratorio['telefono'] ?? '') ?>"
                                       maxlength="20">
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="email" 
                                       ...
                                       id="email" 
                                       name="email" 
                                       value="<?= htmlspecialchars($old['email'] ?? $laboratorio['email'] ?? '') ?>"
                                       maxlength="100">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       value="<?= htmlspecialchars($old['contacto_nombre'] ?? $laboratorio['contacto_nombre'] ?? '') ?>"
                                       maxlength="150">
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       value="<?= htmlspecialchars($old['contacto_telefono'] ?? $laboratorio['contacto_telefono'] ?? '') ?>"
                                       maxlength="20">
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="email" 
                                       ...
                                       id="contacto_email" 
                                       name="contacto_email" 
                                       value="<?= htmlspecialchars($old['contacto_email'] ?? $laboratorio['contacto_email'] ?? '') ?>"
                                       maxlength="100">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       value="<?= htmlspecialchars($old['dias_entrega_promedio'] ?? $laboratorio['dias_entrega_promedio'] ?? '3') ?>"
                                       min="0">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" 
                                           ...
                                           id="activo" 
                                           name="activo"
                                           <?= (isset($old['activo']) ? $old['activo'] : $laboratorio['activo']) ? 'checked' : '' ?>>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control" 
                                          id="observaciones" 
                                          name="observaciones" 
                                          rows="3"><?= htmlspecialchars($old['observaciones'] ?? $laboratorio['observaciones'] ?? '') ?></textarea>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary btn-lg">
                                <i class="fas fa-save me-2"></i>Actualizar Laboratorio
                            </button>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-3">
            <div class="card shadow-sm border-secondary mb-3 sticky-top" style="top: 20px;">
                ...
                <div class="card-body">
                    <table class="table table-sm table-borderless mb-0">
                        ...
                        <tr>
                            ...
                            <td><code><?= htmlspecialchars($laboratorio['codigo']) ?></code></td>
                        </tr>
                        <tr>
            ...
            <div class="card shadow-sm border-info">
                ...
                <div class="card-body">
                    <p class="small text-muted mb-2">
                        <i class="fas fa-check-circle text-success"></i> <strong>Campos obligatorios:</strong> Solo código y nombre.
                    </p>
                    <p class="small text-muted mb-2">
                        <i class="fas fa-info-circle text-info"></i> <strong>Datos de contacto:</strong> Útiles para coordinación de muestras.
                    </p>
                    <p class="small text-muted mb-0">
                        <i class="fas fa-clock text-warning"></i> <strong>Días de entrega:</strong> Ayuda a estimar tiempos de resultados.
                    </p>
                </div>
            </div>
        </div>
...
$(document).ready(function() {
    ...
    const originalData = $('#formLaboratorio').serialize();

    // Detectar cambios en el formulario
    $('#formLaboratorio input, #formLaboratorio textarea, #formLaboratorio select').on('change input', function() {
        formChanged = ($('#formLaboratorio').serialize() !== originalData);
    });
